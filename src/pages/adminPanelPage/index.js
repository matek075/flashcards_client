...
const AdminPage = () => {
  ...
  const handleSubmitQuizQuestion = async event => {
    event.preventDefault();
    if (
      state.quizQuestion.trim() === '' ||
      state.quizQuestionAnswer1.trim() === '' ||
      state.quizQuestionAnswer2.trim() === '' ||
      state.quizQuestionAnswer3.trim() === '' ||
      state.quizQuestionAnswer4.trim() === '' ||
      state.quizQuestionCorrectAnswer.trim() === ''
    ) {
    ...
    <Background width="100%">
      ...
      <Form style={{ width: '40vw' }} onSubmit={handleSubmit}>
        <Form.Group controlId="formBasicFront">
          <Form.Control placeholder="pytanie" name="question" value={state.question} onChange={handleChange} />
        </Form.Group>
        <Form.Group controlId="formBasicBack">
          <Form.Control placeholder="odpowiedź" name="answear" value={state.answear} onChange={handleChange} />
        </Form.Group>
        <Form.Group controlId="FormBasicLanguage">
          <Form.Control as="select" custom name="language" value={state.language} onChange={handleChange}>
        ...
        <Form.Group controlId="formBasicType">
          <Form.Control as="select" custom name="type" value={state.type} onChange={handleChange}>
      ...
      <Form style={{ width: '40vw' }} onSubmit={handleSubmitQuizQuestion}>
        <Form.Group controlId="quizQuestion">
          <Form.Control placeholder="pytanie" name="quizQuestion" value={state.quizQuestion} onChange={handleChange} />
        </Form.Group>
